...
<?php } else { ?>
 ...
 <div id="page">
	<div id="header">
		<div id="logo" class="left"> <a href="/<?php print$homeLink;?>"><img src="/zImageCache/Scale/222/75/<?php echo $um->getLogo(); ?>" alt="Logo"/></a></div>
	...
	<div id="navcontainer">
		<div id="nav">
			...
			<?php if($user || !$logged_in){
				...
				<?php }?>
			 <?php }else if(!$admin){?>
			 	<li><a href="/HealthCoach/Index/" <?=$classes[0][7]?>><span <?=$classes[1][7]?>>Home</span></a></li>
			 	<li><a href="/HealthCoach/CallLog/" <?=$classes[0][8]?>><span <?=$classes[1][8]?>>Call Log</span></a></li>
			 	<li><a href="/HealthCoach/GetUsers/" <?=$classes[0][9]?>><span <?=$classes[1][9]?>>View user</span></a></li>
			 <?php }else{?>
	...
	<div id="container">
        ...
        <div id="healthcoach-nav">
            ...
            <ul id="navlist">
<!--                  <li><a href="/HealthCoach/Index" <?=$classes[0][7]?>><span <?=$classes[1][7]?>>HOME</span></a></li>	-->
                <li><a href="/Messages/Index" <?=$classes[0][10]?>><span <?=$classes[1][10]?>>CHECK MESSAGES</span></a></li>
                <li><a href="/HealthCoach/CallLog" <?=$classes[0][8]?>><span <?=$classes[1][8]?>>CALL LOG</span></a></li>
                <li><a href="/HealthCoach/GetUsers" <?=$classes[0][9]?>><span <?=$classes[1][9]?>>VIEW USER INFO</span></a></li>
            </ul>
            <div class="clear"> </div>
        </div>
		<?php } else if ($cid > 0) { ?>
<!-- Login / Registration page -->
 <div id="page">
	<div id="header">
		<div id="logo" class="left"> <a href="/<?php print$homeLink;?>"><img src="/zImageCache/Scale/222/50/<?php echo $um->getLogo(); ?>" alt="Logo"/></a></div>
